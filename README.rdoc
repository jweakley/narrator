...
Once you have the Narrator gem install you will need to run the generator:

    rails generate narrator:migration
...
Any model that we would like to have tracked by narrator needs to have <tt>narratble_model</tt> added to it.
...
=== 2. Narrate the Model's activities from the controller
