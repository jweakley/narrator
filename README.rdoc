...
[![Gem Version](https://badge.fury.io/rb/narrator.png)](http://badge.fury.io/rb/narrator) [![Build Status](https://travis-ci.org/jweakley/narraotr.png?branch=master)](https://travis-ci.org/jweakley/narraotr) [![Dependency Status](https://gemnasium.com/jweakley/narrator.png)](https://gemnasium.com/jweakley/narrator) [![Code Climate](https://codeclimate.com/github/jweakley/narrator.png)](https://codeclimate.com/github/jweakley/narrator) [![Coverage Status](https://coveralls.io/repos/jweakley/narrator/badge.png?branch=master)](https://coveralls.io/r/jweakley/narrator)
